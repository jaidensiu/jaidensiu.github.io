...
const experiences = [
    {
        ...
        stack: ['Kotlin', 'Jetpack Compose', 'Android Studio', 'Swift', 'SwiftUI', 'Xcode']
    },
    {
        ...
        stack: ['Kotlin', 'Java', 'Espresso', 'Android Studio', 'Jenkins']
    }
]

const projects = [  
    {
        name: 'UBC MINT (Multifaced Innovations in NeuroTechnology)',
        ...
        stack: ['Python', 'HTML', 'CSS', 'JavaScript', 'TypeScript', 'MongoDB', 'Express', 'React', 'Node', 'Unity', 'Tkinter'],
    ...
    },
    {
        ...
        stack: ['Java', 'Spring Boot', 'MongoDB', 'React', 'Bootstrap', 'Axios', 'Postman', 'IntelliJ', 'VS Code'],
    ...
    },
    {
        ...
        photo: null,
        stack: ['Express', 'Node', 'JavaScript', 'Java', 'Android Studio', 'VS Code', 'MySQL', 'Postman'],
